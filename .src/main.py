...
parser.add_argument("-v", "--verbose", help=f"{white}[RECOMMENDED] enable verbosity ({green}show network logs,errors, and notices{white}){reset}", dest="verbose", action="store_true")
